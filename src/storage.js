...
class ClassroomHubStorage{
  ...
  getAdminConfig(){
    ...
    const site=this.getSetting("site.profile",{school:"Your Organization",room:devices.room||"Classroom",timezone:"America/New_York",productName:"Classroom Control Hub",logoUrl:"",displayPrefix:"TV"});
  ...
  putSiteProfile(value){const current=this.getSetting("site.profile",{}),next={...current,...(value||{})};this.setSetting("site.profile",next);return next}
