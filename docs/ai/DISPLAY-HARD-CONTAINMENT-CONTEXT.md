...
Renderer revision `single-fit-20260909-4` defines a non-negotiable containment rule: configured font sizes are preferences/maxima, not guarantees. Title, subtitle, body and timer text must shrink until every actual rendered text rectangle is inside its assigned region.
