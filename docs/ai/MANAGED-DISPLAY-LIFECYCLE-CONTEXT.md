...
- `Remove from Hub` deletes only the selected enrollment record. It must not uninstall `org.classroomhub.display`, factory-reset Android, delete the shared Android data directory, or affect other Classroom Hub data.
