...
At the time this document was updated, `1.0.0-alpha.69` is the live-test candidate baseline. It includes configurable school scheduling plus the dependency, API privacy, capability, agent-enrollment, updater, recovery, and maintenance-plane hardening described in the changelog.
