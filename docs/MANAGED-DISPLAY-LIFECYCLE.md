...
Managed Displays are durable Classroom Hub enrollments. A device record may survive temporary ADB loss, Android reboots, randomized wireless-debugging ports, and Agent v2 transport changes.
