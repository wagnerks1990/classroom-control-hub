...
The first agent-first management pilot moves Wireless Debugging policy maintenance into the Classroom Hub Display Agent while retaining ADB for one-time bootstrap and emergency recovery.
...
3. Keep the Classroom Hub display activity running.
